...
We can see that substrate choice (and to a lesser extent *Trichoderma* addition) seems to have an effect on the weight of curved strawberries. The choice of greenhouse, however, does not seem to have an effect but a slightly higher variance can be observed for greenhouse 1.
...
```{r}
# this is how it is performed in practical session 1 exercise 2
