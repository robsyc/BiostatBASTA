...
fit3 = lm(Curved_strawberries ~ Substrate + Trichoderma + Substrate:Trichoderma, 
...
```
```{r}
fit4 = lm(Curved_strawberries ~ Substrate + Trichoderma + Substrate:Trichoderma, data = df_t)
summary(fit4)
par(mfrow = c(1,1))
plot(fit4)
