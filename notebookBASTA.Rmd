...
Due to the limited number of observations and large number of variables, trends in these plots should not be taken for granted and further statistical investigation will be performed.

# Model Selection & Statisticial Inference

I've added this assumption checking part because I thought normality was a problem but performing log-transorm does not help :( A square root transformation seems to do somewhat better. I noticed there is a value 0 in our dataset (no curved strawberreis -> thus weight is 0) should be remove this? Since it is not really a data point I think.
...
```{r warning=FALSE}
df_log <- df
df_log$Curved_strawberries <- ((df_log$Curved_strawberries)^0.2)
