...
An ANOVA test indicated that there are only significant differences in the weight of curved strawberries between different substrates.Further analysis with a Tukey post-hoc then compared the effect between the different substrates. The analysis indicated that a significant difference in the weight of the curved strawberries can be found when comparing peatfree substrate with biochar with substrate containing peat and biochar (p = 0,021). This difference in average weight of the curved strawberries when using peatfree substrate with biochart or substrate containing peat with biochar is 1.094803e-05. Which is very small.
