...
It can be concluded that only a significant difference in number of curved strawberries can be found when comparing peatfree substrate with biochar and substrate with peat and biochar (p-value = 0,021). 


```{r}
# Ik denk dat dit allemaal weg mag???
